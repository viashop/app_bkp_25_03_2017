...
<div class="row">
    <div class="col-md-12">
        ...
        <div class="card">
            ...
            <div class="content">
                {!! Form::open(['route' => ['control.users.admin.update.trashed.post', $user->id], 'role' => 'form']) !!}
                ...
                &nbsp;
                &nbsp;
                {{ link_to_route('control.users.admin.read.trashed', $title = 'Cancelar', $parameters = [], $attributes = ['title' => 'Cancelar']) }}
