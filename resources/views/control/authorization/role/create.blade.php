    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="content">
                    {!! Form::open(['route' => 'control.authorization.role.create.post', 'role' => 'form']) !!}
                    ...
                    &nbsp;
                    &nbsp;
                    {{ link_to_route('control.authorization.role.read', $title = 'Cancelar', $parameters = [], $attributes = ['title' => 'Cancelar']) }}
