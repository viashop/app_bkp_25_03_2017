...
return [
    ...
    */
    ...
    'custom' => [
        'name' => [
            'required' => 'Por favor, informe seu nome corretamente.',
            'min' => 'Seu nome deve ter no mínimo :min caracteres.',
            'max' => 'Seu nome deve ter no máximo :max caracteres.',
        ],

        'email' => [
            'required' => 'Por favor, informe seu email corretamente.',
        ],

        'role_id' => [
            'required' => 'Por favor, selecione a função corretamente.',
        ],

        'password' => [
            'required' => 'Por favor, informe sua senha corretamente.',
            'min' => 'A senha deve ter no mínimo :min caracteres.',
            'max' => 'A senha deve ter no máximo :max caracteres.',
        ],

        'confirm' => [
            'required' => 'Por favor, informe a confirmação de senha corretamente.',
            'min' => 'A confirmação de senha deve ter no mínimo :min caracteres.',
            'max' => 'A confirmação de senha deve ter no máximo :max caracteres.',
        ],
    ],
